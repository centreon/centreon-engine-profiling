...
#  define CENTREON_PROFILING_VERSION_MAJOR  1
#  define CENTREON_PROFILING_VERSION_MINOR  1
#  define CENTREON_PROFILING_VERSION_PATCH  0
#  define CENTREON_PROFILING_VERSION_STRING "1.1.0"
